...
import { HomeIcon, Cog6ToothIcon, QuestionMarkCircleIcon, IdentificationIcon, UsersIcon } from '@heroicons/react/24/outline';
import { LeafIcon, Droplets } from 'lucide-react';
import { NavLink } from 'react-router-dom';

const navItems = [
  {label: 'Dashboard', icon: HomeIcon, route:'/dashboard'},
  {label: 'My Plants', icon:LeafIcon, route:'/plants'},
  {label: 'Care', icon: Droplets, route:'/care'},
  {label: 'Find Plant', icon: IdentificationIcon, route:'/find-plant'},
  {label: 'Community', icon: UsersIcon, route:'/community'}
]
    ...
    <nav className='flex flex-col justify-between w-64 min-h-screen bg-white border-r border-gray-200 px-4 py-6 fixed top-0 left-0 h-screen z-30'>
      <div>
           ...
           <div className="flex items-center gap-3">
             ...
             />
             <span className='text-2xl font-bold text-green-600'>Cultiva</span>
           </div>
         </div>
